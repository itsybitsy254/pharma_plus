...
<div class="container mx-auto p-6">
    <h1 class="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100">Add User</h1>
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg max-w-2xl mx-auto">
        <form action="{{ route('users.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                <label class="block text-gray-700 dark:text-gray-200 font-semibold mb-1">Password</label>
            ...
            <div class="flex justify-end space-x-2">
                ...
                <button type="submit" 
                        class="px-5 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">Add User</button>
            </div>
        </form>
    </div>
</div>
